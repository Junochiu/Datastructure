...
{
	fstream file;
	file.open("0610785_7_22.txt",ios::in);
	if(!file)
	...
	int choice;
	cout<<"# 7_22 implement student data func with tree \n";
	while(1)
	{
		cout<<"===============================================================================\n";
...
{
	fstream file;
	file.open("0610785_7_22.txt",ios::app);
	DATA *newdata = new DATA();
...
void delet (BST_TREE* tree)
{
	...
	fstream file;
	file.open("0610785_7_22.txt",ios::out);
	file<<"";
